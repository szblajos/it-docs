...
const config = {
  ...
  tagline: 'Information Technology Documentation by Lajos Szabó',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://szblajos.github.io',
  ...
  organizationName: 'szblajos', // Usually your GitHub org/user name.
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: 'IT Documentation',
        logo: {
          alt: "Lajos Szabó's Avatar",
          src: 'https://avatars.githubusercontent.com/u/36035869?v=4',
        },
        items: [
          {
          ...
          },
          {
            ...
            sidebarId: 'petStoreApiSidebar', // Az API oldalsávjának ID-ja a sidebars.js-ből
            label: 'Petstore API',
            position: 'left',
          },
